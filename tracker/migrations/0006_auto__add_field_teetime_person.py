...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeeTime.person'
        db.add_column('tracker_teetime', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User'], blank=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'TeeTime.person'
        db.delete_column('tracker_teetime', 'person_id')
    ...
    models = {
        ...
        'tracker.teetime': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.User']", 'blank': 'True', 'null': 'True'}),
