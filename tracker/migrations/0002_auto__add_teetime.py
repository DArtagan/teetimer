...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TeeTime'
        db.create_table('tracker_teetime', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_edited', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('slots', self.gf('django.db.models.fields.IntegerField')()),
            ('people', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.User'])),
        ))
        db.send_create_signal('tracker', ['TeeTime'])


    def backwards(self, orm):
        # Deleting model 'TeeTime'
        db.delete_table('tracker_teetime')
    ...
    models = {
        ...
        'tracker.teetime': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'people': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounts.User']"}),
